...
- 컴포넌트 기반 아키텍처는 매우 단순.
- 앞서 소개했던 4개 규칙을 생각해 보면 됨.
- 쉬운 만큼 잘 지켜짐.
- 헥사고날 아키텍처는 애플리케이션 레벨의 경계를 다룸.
- 컴포넌트 기반 아키텍처는 컴포넌트 레벨의 경계를 다룸.
- 헥사고날 아키텍처 내에서 컴포넌트 기반 아키텍처를 두고 시작해 볼 수.
- 그리고 필요에 따라 다른 아키텍처로 발전시킬 수도.
- 컴포넌트 기반 아키텍처는 쉽게 이동시키고 리팩토링할 수 있음.
