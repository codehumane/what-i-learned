...
개인적인 생각이지만, 이런 부분 때문에 XA는 더더욱 위험. 인스턴스는 언제든 버려질 지도 모르는 일. 또, 같은 DB라도 분리가 되어 있거나, 심지어 아예 서로 다른 기술이 사용된다면, 트랜잭션으로 강하게 묶여야 할 가능성도 매우 낮아 보임. 정말 필요한 일인지부터 고민해봐야 하지 않을까. 혹은 경계가 잘못 나뉘어 진 것.
