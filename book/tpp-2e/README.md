...
- 소프트웨어를 작성하도록 부탁하는 사람을 클라이언트라고 부르자.
- 일반적인 클라이언트는 요구를 들고 찾아옴.
...
- 경험 많은 개발자는 이렇게 팩트만 전달하고 결정은 클라이언트에게 맡김.

### Requirements Are a Process

- 앞선 예제에서 개발자가 요구사항을 받고 피드백을 클라이언트에 전달.
- 이제 탐험이 시작된 것.
- 클라이언트는 이런 저런 해결책을 생각해 보게 되고,
