...
- [The Four Golden Signals](/book/sre/README.md#the-four-golden-signals)


# 04/25

[우연의 법칙을 어떻게 사용해야 할까?](/book/the-improbability-principle/README.md#%EC%9A%B0%EC%97%B0%EC%9D%98-%EB%B2%95%EC%B9%99%EC%9D%84-%EC%96%B4%EB%96%BB%EA%B2%8C-%EC%82%AC%EC%9A%A9%ED%95%B4%EC%95%BC-%ED%95%A0%EA%B9%8C) 정리.
...
[생명과 우주에도 우연은 있다](/book/the-improbability-principle/README.md#%EC%83%9D%EB%AA%85%EA%B3%BC-%EC%9A%B0%EC%A3%BC%EC%97%90%EB%8F%84-%EC%9A%B0%EC%97%B0%EC%9D%80-%EC%9E%88%EB%8B%A4) 정리. 프레드 호일의 보잉747 이야기와 과학이 다루는 것은 절대적 진리가 아닌 가능성이라는 이야기.
...
- [Worrying About Your Tail (or, Instrumentation and Performance](/book/sre/README.md#worrying-about-your-tail-or-instrumentation-and-performance)
- [Choosing an Appropriate Resolution for Measurements](/book/sre/README.md#choosing-an-appropriate-resolution-for-measurements)
- [As Simple as Possible, No Simpler](/book/sre/README.md#choosing-an-appropriate-resolution-for-measurements)

# 05/01

## SRE

[Trying These Principles Together](/book/sre/README.md#trying-these-principles-together)
...
더불어, [Monitoring for the Long Term](/book/sre/README.md#monitoring-for-the-long-term) 기록도 함께 진행.
...
- [도메인 주도 설계 구현](/book/iddd/README.md)의 [14장. 애플리케이션](/book/iddd/README.md#14%EC%9E%A5-%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98) 정리.
...
- [Internals vs. Peers](/book/goosgt/README.md#internals-vs-peers)
- [No And's, Or's, Or But's](/book/goosgt/README.md#no-ands-ors-or-buts)
- [Object Peer Stereotypes](/book/goosgt/README.md#object-peer-stereotypes)
...
[Composite Simpler Than The Sum Of Its Parts](/book/goosgt/README.md#composite-simpler-than-the-sum-of-its-parts)
...
[Context Independence](/book/goosgt/README.md#context-independence)
...
- [Achieving Object-Oriented Design](/book/goosgt/README.md#achieving-object-oriented-design) 요약 시작
- [How Writing A Test First Helps The Design](/book/goosgt/README.md#how-writing-a-test-first-helps-the-design)

# 05/13

## GOOSGT

- [Communication Over Classification](/book/goosgt/README.md#communication-over-classification)
- [Value Types](/book/goosgt/README.md#value-types)
- [Where Do Objects Come From?](/book/goosgt/README.md#where-do-objects-come-from)

# 05/15

## GOOSGT

- [Identify Relationships With Interface](/book/goosgt/README.md#identify-relationships-with-interfaces)
- [Refactor Interfaces Too](/book/goosgt/README.md#refactor-interfaces-too)
- [Compose Objects To Describe System Behavior](/book/goosgt/README.md#compose-objects-to-describe-system-behavior)
- [Building Up To Higher-Level Programming](/book/goosgt/README.md#building-up-to-higher-level-programming)

# 05/16

## GOOSGT

- [Test-Driven Development with Objects](/book/goosgt/README.md#test-driven-development-with-objects) 정리 시작
- [A Web of Objects](/book/goosgt/README.md#a-web-of-objects)
- [Values and Objects](/book/goosgt/README.md#values-and-objects)
...
오늘도 GOOSGT 정리. 그 중에서 [Follow the Messages](/book/goosgt/README.md#follow-the-messages) 부분.
...
- [Tell, Don't Ask](/book/goosgt/README.md#tell-dont-ask)
- [But Sometimes Ask](/book/goosgt/README.md#but-sometimes-ask)
- [Unit-Testing The Collaborating Objects](/book/goosgt/README.md#unit-testing-the-collaborating-objects)
