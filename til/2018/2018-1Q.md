...
- [[도메인 주도 설계 핵심] 컨텍스트 매핑과 전략적 설계](/book/dddd/README-ko.md#컨텍스트-매핑과-전략적-설계)
...
- [[도메인 주도 설계 핵심] 애그리게잇과 전술적 설계](/book/dddd/README-ko.md#애그리게잇과-전술적-설계)
- [[알고리즘] 그래프의 경로](/book/algorithm/paths-in-graph.md)
- [유니버설 해싱](/book/algorithm/number-algorithm.md#유니버설-해싱)에 대해 다시 살펴봄.
...
- [[알고리즘] 그래프의 경로](/book/algorithm/paths-in-graph.md#%EA%B7%B8%EB%9E%98%ED%94%84%EC%9D%98-%EA%B2%BD%EB%A1%9C)
  - [간선의 길이](/book/algorithm/paths-in-graph.md#%EA%B0%84%EC%84%A0%EC%9D%98-%EA%B8%B8%EC%9D%B4)
  - [데이크스트라 알고리즘](/book/algorithm/paths-in-graph.md#%EB%8D%B0%EC%9D%B4%ED%81%AC%EC%8A%A4%ED%8A%B8%EB%9D%BC-%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98)

# 01/14

- [[알고리즘] 그래프의 경로 - 우선순위 큐 구현](/book/algorithm/paths-in-graph.md#%EC%9A%B0%EC%84%A0%EC%88%9C%EC%9C%84-%ED%81%90-%EA%B5%AC%ED%98%84)
...
![http vary](/til/2018/http-vary.png)

- [HTTP 완벽 가이드 - HTTP 개관](/book/http-definitive-guide/README.md#http-%EA%B0%9C%EA%B4%80)
- [HTTP 완벽 가이드 - URL과 리소스](/book/http-definitive-guide/README.md#url%EA%B3%BC-%EB%A6%AC%EC%86%8C%EC%8A%A4)
- [HTTP 완벽 가이드 - HTTP 메시지](/book/http-definitive-guide/README.md#http-%EB%A9%94%EC%8B%9C%EC%A7%80)
...
![IEEE 754](/til/2018/IEEE_754.png)
...
- HTTP 완벽 가이드, [간단한 펄 웹서버](/book/http-definitive-guide/README.md#%EA%B0%84%EB%8B%A8%ED%95%9C-%ED%8E%84-%EC%9B%B9%EC%84%9C%EB%B2%84)
...
- [사이트 신뢰성 엔지니어링](/book/sre/README.md) 책을 읽기 시작. 재밌다.
...
- [SRE 관점에서 바라본 구글의 프로덕션 환경](/book/sre/README.md#sre-%EA%B4%80%EC%A0%90%EC%97%90%EC%84%9C-%EB%B0%94%EB%9D%BC%EB%B3%B8-%EA%B5%AC%EA%B8%80%EC%9D%98-%ED%94%84%EB%A1%9C%EB%8D%95%EC%85%98-%ED%99%98%EA%B2%BD)
...
- [위험 요소 수용하기](/book/sre/README.md#%EC%9C%84%ED%97%98-%EC%9A%94%EC%86%8C-%EC%88%98%EC%9A%A9%ED%95%98%EA%B8%B0)
...
- [Service Level Objectives](/book/sre/README.md#service-level-objectives) 정리.
...
- [SRE, Eliminating Toil](/book/sre/README.md#eliminating-toil) 정리
