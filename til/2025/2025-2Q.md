...
[CircuitBreaker](/document/resilience4j-circuitbreaker.md#circuitbreaker)

- [Introduction](/document/resilience4j-circuitbreaker.md#introduction)
- [Count-based sliding window](/document/resilience4j-circuitbreaker.md#count-based-sliding-window)
- [Time-based sliding window](/document/resilience4j-circuitbreaker.md#time-based-sliding-window)
- [Failure rate and slow call rate thresholds](/document/resilience4j-circuitbreaker.md#failure-rate-and-slow-call-rate-thresholds)

# 04/19

## Burn Rate Alert

- [Summary](/document/burn-rate.md#summary)
- [How Burn Rate Alerts work](/document/burn-rate.md#how-burn-rate-alerts-work)
- [Maximum burn rate values](/document/burn-rate.md#maximum-burn-rate-values)
- [Picking burn rate values](/document/burn-rate.md#picking-burn-rate-values)
- [Examples](/document/burn-rate.md#examples)

## 카프카 핵심 가이드 2판

13장. 카프카 모니터링하기

- [13.1.2 어떤 지표가 필요한가?](/book/ktdg-2e/README.md#1312-%EC%96%B4%EB%96%A4-%EC%A7%80%ED%91%9C%EA%B0%80-%ED%95%84%EC%9A%94%ED%95%9C%EA%B0%80)
- [13.2.1 서비스 수준 정의](/book/ktdg-2e/README.md#1321-%EC%84%9C%EB%B9%84%EC%8A%A4-%EC%88%98%EC%A4%80-%EC%A0%95%EC%9D%98)
- [13.2.3 경보에 SLO를 사용하기](/book/ktdg-2e/README.md#1323-%EA%B2%BD%EB%B3%B4%EC%97%90-slo%EB%A5%BC-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0)
- [13.4.1 프로듀서 지표](/book/ktdg-2e/README.md#1341-%ED%94%84%EB%A1%9C%EB%93%80%EC%84%9C-%EC%A7%80%ED%91%9C)
...
- [13.4.2 컨슈머 지표](/book/ktdg-2e/README.md#1342-%EC%BB%A8%EC%8A%88%EB%A8%B8-%EC%A7%80%ED%91%9C)
- [13.4.3 쿼터](/book/ktdg-2e/README.md#1343-%EC%BF%BC%ED%84%B0)
- [13.5 랙 모니터링](/book/ktdg-2e/README.md#135-%EB%9E%99-%EB%AA%A8%EB%8B%88%ED%84%B0%EB%A7%81)
