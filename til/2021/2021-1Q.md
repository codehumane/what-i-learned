...
- [What's Wrong with Layers?](/book/gyhdca/README.md#whats-wrong-with-layers)

# 02/15

## Get Your Hands Dirty on Clean Architecture

- [Inverting Dependencies](/book/gyhdca/README.md#inverting-dependencies)

# 02/18

## Get Your Hands Dirty on Clean Architecture

- [Organizing Code](/book/gyhdca/README.md#organizing-code)

# 02/20

## Get Your Hands Dirty on Clean Architecture

- [Implementing a Use Case](/book/gyhdca/README.md#implementing-a-use-case)
  - [Implementing the Domain Model](/book/gyhdca/README.md#implementing-the-domain-model)
  - [A Use Case in a Nutshell](/book/gyhdca/README.md#a-use-case-in-a-nutshell)
  - [Validating Input](/book/gyhdca/README.md#validating-input)
  - [Validating Business Rules](/book/gyhdca/README.md#validating-business-rules)
  - [Rich versus Anemic Domain Model](/book/gyhdca/README.md#rich-versus-anemic-domain-model)
  - [Different Output Models for Different Use Cases](/book/gyhdca/README.md#different-output-models-for-different-use-cases)
  - [What about Read-Only Use Cases?](/book/gyhdca/README.md#what-about-read-only-use-cases)

# 02/21

## Get Your Hands Dirty on Clean Architecture

- [Implementing a Web Adapter](/book/gyhdca/README.md#implementing-a-web-adapter)
  - [Dependency Inversion](/book/gyhdca/README.md#dependency-inversion)
  - [Responsibilities of a Web Adapter](/book/gyhdca/README.md#respnsibilities-of-a-web-adapter)
  - [Slicing Controllers](/book/gyhdca/README.md#slicing-controllers)
- [Implementing a Persistence Adapter](/book/gyhdca/README.md#implementing-a-persistence-adapter)
    - [Dependency Inversion](/book/gyhdca/README.md#dependency-inversion-1)
    - [The Responsibilities of a Persistence Adapter](/book/gyhdca/README.md#the-responsibilities-of-a-persistence-adapter)
    - [Slicing Port Interfaces](/book/gyhdca/README.md#slicing-port-interfaces)
    - [Slicing Persistence Adapters](/book/gyhdca/README.md#slicing-persistence-adapters)
    - [Example with Spring Data JPA](/book/gyhdca/README.md#example-with-spring-data-jpa)
...
- [Example with Spring Data JPA](/book/gyhdca/README.md#example-with-spring-data-jpa)
- [What abount Database Transactions?](/book/gyhdca/README.md#what-abount-database-transactions)

# 02/24

## Get Your Hands Dirty on Clean Architecture

- [Mapping Between Boundaries](/book/gyhdca/README.md#mapping-between-boundaries)
  - [The "No Mapping" Strategy](/book/gyhdca/README.md#the-no-mapping-strategy)
  - [The "Two-Way" Mapping Strategy](/book/gyhdca/README.md#the-two-way-mapping-strategy)
  - [The "Full" Mapping Strategy](/book/gyhdca/README.md#the-full-mapping-strategy)
  - [The "One-Way" Mapping Strategy](/book/gyhdca/README.md#the-one-way-mapping-strategy)
  - [When to Use Which Mapping Strategy?](/book/gyhdca/README.md#when-to-use-which-mapping-strategy)

# 02/25

## Get Your Hands Dirty on Clean Architecture

- [Assembling the Application](/book/gyhdca/README.md#assembling-the-application)
    - [Assembling via Plain Code](/book/gyhdca/README.md#assembling-via-plain-code)
    - [Assembling via Spring's Classpath Scanning](/book/gyhdca/README.md#assembling-via-springs-classpath-scanning)
    - [Assembling via Spring's Java Config](/book/gyhdca/README.md#assembling-via-springs-java-config)

# 02/26

## Get Your Hands Dirty on Clean Architecture

- [Enforcing Architecture Dependencies](/book/gyhdca/README.md#enforcing-architecture-boundaries)
    - [Boundaries and Dependencies](/book/gyhdca/README.md#boundaries-and-dependencies)
    - [Visibility Modifiers](/book/gyhdca/README.md#visibility-modifiers)
    - [Post-Compile Checks](/book/gyhdca/README.md#post-compile-checks)
    - [Build Artifacts](/book/gyhdca/README.md#build-artifacts)
- [Taking Shortcuts Consciously](/book/gyhdca/README.md#taking-shortcuts-consciously)
    - [Why Shortcuts Are Like Broken Windows](/book/gyhdca/README.md#why-shortcuts-are-like-broken-windows)
    - [The Responsibility of Starting Clean](/book/gyhdca/README.md#the-responsibility-of-starting-clean)
    - [Sharing Models between Use Cases](/book/gyhdca/README.md#sharing-models-between-use-cases)
    - [Using Domain Entities as Input or Output Models](/book/gyhdca/README.md#using-domain-entities-as-input-or-output-models)
    - [Skipping Incoming Ports](/book/gyhdca/README.md#skipping-incoming-ports)
    - [Skipping Application Services](/book/gyhdca/README.md#skipping-application-services)
...
- 책 마지막 내용.
- 클린 아키텍처 보다 더 재미있었음.
- [Deciding on an Architecutre Style](/book/gyhdca/README.md#deciding-on-an-architecture-style)
    - [The Domain is King](/book/gyhdca/README.md#the-domain-is-king)
    - [Experience is Queen](/book/gyhdca/README.md#experience-is-queen)
    - [It Depends](/book/gyhdca/README.md#it-depends)
