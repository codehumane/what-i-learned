...
- [User Provides Identity](https://github.com/codehumane/what-i-learned/tree/master/iddd#user-provides-identity)
- [Application Generates Identity](https://github.com/codehumane/what-i-learned/tree/master/iddd#application-generates-identity)
- [Persistence Mechanism Generates Identity](https://github.com/codehumane/what-i-learned/tree/master/iddd#persistence-mechanism-generates-identity)
- [When the Timing of Identity Generation Matters](https://github.com/codehumane/what-i-learned/tree/master/iddd#when-the-timing-of-identity-generation-matters)
- [Surrogate Identity](https://github.com/codehumane/what-i-learned/tree/master/iddd#surrogate-identity)
