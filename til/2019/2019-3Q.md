...
- [Single-leader replication and consensus](/book/ddia/Distributed-Data.md#single-leader-replication-and-consensus)
- [Epoch numbering and quorums](/book/ddia/Distributed-Data.md#epoch-numbering-and-quorums)

# 08/09

## Designing Data-Intensive Applications

- [Limitations of consensus](/book/ddia/Distributed-Data.md#limitations-of-consensus)

# 08/11

## Designing Data-Intensive Applications

- [Membership and Coordination Services](/book/ddia/Distributed-Data.md#membership-and-coordination-services)

# 08/14

## Designing Data-Intensive Applications

- [Allocating work to nodes](/book/ddia/Distributed-Data.md#allocating-work-to-nodes)
- [Service discovery](/book/ddia/Distributed-Data.md#service-discovery)
- [Membership services](/book/ddia/Distributed-Data.md#membership-services)

# 08/19

- [Consistency and Consensus의 요약](/book/ddia/Distributed-Data.md#summary-1)
...
- [1장 설계와 아키텍처란?](/book/clean-architecture/README.md#1%EC%9E%A5-%EC%84%A4%EA%B3%84%EC%99%80-%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98%EB%9E%80)

# 09/03

## Clean Architecture

- [8장 OCP: 개방-폐쇄 원칙](/book/clean-architecture/README.md#8%EC%9E%A5-ocp-%EA%B0%9C%EB%B0%A9-%ED%8F%90%EC%87%84-%EC%9B%90%EC%B9%99)
...
### [11장 DIP: 의존성 역전 원칙](/book/clean-architecture/README.md#11%EC%9E%A5-dip-%EC%9D%98%EC%A1%B4%EC%84%B1-%EC%97%AD%EC%A0%84-%EC%9B%90%EC%B9%99)

- [변동성<sup>volatile</sup>](/book/clean-architecture/README.md#%EB%B3%80%EB%8F%99%EC%84%B1volatile)
- [안정된 추상화](/book/clean-architecture/README.md#%EC%95%88%EC%A0%95%EB%90%9C-%EC%B6%94%EC%83%81%ED%99%94)
- [구체 컴포넌트](/book/clean-architecture/README.md#%EA%B5%AC%EC%B2%B4-%EC%BB%B4%ED%8F%AC%EB%84%8C%ED%8A%B8)

# 09/13

## 클린 아키텍처

### [13장 컴포넌트 응집도](/book/clean-architecture/README.md#13%EC%9E%A5-%EC%BB%B4%ED%8F%AC%EB%84%8C%ED%8A%B8-%EC%9D%91%EC%A7%91%EB%8F%84)

- [REP](/book/clean-architecture/README.md#rep-%EC%9E%AC%EC%82%AC%EC%9A%A9%EB%A6%B4%EB%A6%AC%EC%8A%A4-%EB%93%B1%EA%B0%80-%EC%9B%90%EC%B9%99)
- [CCP](/book/clean-architecture/README.md#ccp-%EA%B3%B5%ED%86%B5-%ED%8F%90%EC%87%84-%EC%9B%90%EC%B9%99)
- [CRP](/book/clean-architecture/README.md#crp-%EA%B3%B5%ED%86%B5-%EC%9E%AC%EC%82%AC%EC%9A%A9-%EC%9B%90%EC%B9%99)
...
- [15장 아키텍처란?](/book/clean-architecture/README.md#15장-아키텍처란)
