...
- [영웅, 선의 그리고 프로페셔널리즘](https://github.com/codehumane/what-i-learned/blob/master/software-craftsman/README.md#%EC%98%81%EC%9B%85-%EC%84%A0%EC%9D%98-%EA%B7%B8%EB%A6%AC%EA%B3%A0-%ED%94%84%EB%A1%9C%ED%8E%98%EC%85%94%EB%84%90%EB%A6%AC%EC%A6%98)
- [동작하는 소프트웨어](https://github.com/codehumane/what-i-learned/blob/master/software-craftsman/README.md#%EB%8F%99%EC%9E%91%ED%95%98%EB%8A%94-%EC%86%8C%ED%94%84%ED%8A%B8%EC%9B%A8%EC%96%B4)
...
- [SSTables and LSM-Trees](https://github.com/codehumane/what-i-learned/tree/master/ddia#sstables-and-lsm-trees)
- [Comparing B-Trees and LSM-Trees](https://github.com/codehumane/what-i-learned/tree/master/ddia#comparing-b-trees-and-lsm-trees)
...
- [Storing Values Within The Index](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#storing-values-within-the-index)
- [Multi-Column Indexes](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#multi-column-indexes)
- [Full-Text Search and Fuzzy Indexes](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#full-text-search-and-fuzzy-indexes)
- [Keeping Everything in Memory](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#keeping-everything-in-memory)

# 09/08

## Designing Data-Intensive Applications

- [Transaction Processing or Analytics?](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#transaction-processing-or-analytics)
  - [Data Warehousing](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#data-warehousing)
  - [Stars and Snowflakes: Schemas for Analytics](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#stars-and-snowflakes-schemas-for-analytics)

# 09/13

## Designing Data-Intensive Applications

### [Column-Oriented Storage](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#column-oriented-storage)

- [Column Compression](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#column-compression)
- [Sort Order in Column Storage](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#sort-order-in-column-storage)
- [Writing to Column-Oriented Storage](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#writing-to-column-oriented-storage)
- [Aggregation: Data Cubes and Materialized Views](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#aggregation-data-cubes-and-materialized-views)

# 09/21

## Designing Data-Intensive Applications

### [Relational Model Versus Document Model](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#relational-model-versus-document-model)

- [The Birth of NoSQL](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#the-birth-of-nosql)
- [The Object-Relational Mismatch](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#the-object-relational-mismatch)
- [Many-to-One and Many-to-Many Relationships](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#many-to-one-and-many-to-many-relationships)
- [Are Document Databases Repeating History?](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#are-document-databases-repeating-history)
- [Relational Versus Document Databases Today](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#relational-versus-document-databases-today)

### [Query Languages for Data](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#query-languages-for-data)

- [Declarative Queries on the Web](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#declarative-queries-on-the-web)
- [MapReduce Querying](https://github.com/codehumane/what-i-learned/blob/master/ddia/README.md#mapreduce-querying)
