...
![green-jelly-beans-linked-to-acne](/til/2017/green-jelly-beans-linked-to-acne.png)
...
![merge-sort-complexity-tree](/til/2017/merge-sort-complexity-tree.png)
...
- [새빨간 거짓말, 통계 (책)](/book/how-to-lie-with-statistics/README.md)
- [언제나 의심스러운 여론조사](/book/how-to-lie-with-statistics/README.md#언제나-의심스러운-여론조사)
- [평균은 하나가 아니다](/book/how-to-lie-with-statistics/README.md#평균은-하나가-아니다)
- [통계도 논리이다](/book/how-to-lie-with-statistics/README.md#숫자로-장난치기)
- [백분율 더하기](/book/how-to-lie-with-statistics/README.md#백분율-더하기)
- [백분율, 백분율점, 백분위수](/book/how-to-lie-with-statistics/README.md#백분율-백분율점-백분위수)
...
- Spring Microservices
  - [Autoscaling Microservices](/book/spring-ms/README.md#autoscaling-microservices)
  - [Spring Microservices with Spring Cloud](/book/spring-ms/README.md#scaling-microservices-with-spring-cloud-1)
  - [Understanding the concept of autoscaling](/book/spring-ms/README.md#understanding-the-concept-of-autoscaling)
  - [Autoscaling Approaches](/book/spring-ms/README.md#autoscaling-approaches)
- 도메인 주도 설계 구현
  - [11장. 팩토리](/book/iddd/README.md#11장-팩토리)
...
- 도메인 주도 설계 구현
  - [도메인 이벤트](/book/iddd/README.md#8장-도메인-이벤트)
  - [언제 그리고 왜 도메인 이벤트를 사용할까](/book/iddd/README.md#언제-그리고-왜-도메인-이벤트를-사용할까)
  - [이벤트 모델링](/book/iddd/README.md#이벤트-모델링)
  - [도메인 모델에서 이벤트를 발행하기](/book/iddd/README.md#도메인-모델에서-이벤트를-발행하기)
  - [원격 바운디드 컨텍스트로 이벤트 전파하기](/book/iddd/README.md#뉴스를-원격-바운디드-컨텍스트로-전파하기)
  - [이벤트 저장소](/book/iddd/README.md#이벤트-저장소)
...
- 알고리즘
  - 그래프의 분할(decompositions of graph), [왜 그래프인가](/book/algorithm/decompositions-of-graph.md)
...
- [유향 비순환 그래프(DAG<sup>Directed Acyclic Graph</sup>)에서의 위상 정렬<sup>topological sort</sup>](/book/algorithm/decompositions-of-graph.md#위상-정렬)
...
- [[알고리즘] 그래프의 순환 - 유향 그래프의 강한 연결 성분](/book/algorithm/decompositions-of-graph.md)
...
- [[도메인 주도 설계 구현] 도메인, 서브도메인, 바운디드 컨텍스트](/book/iddd/README.md#2%EC%9E%A5-%EB%8F%84%EB%A9%94%EC%9D%B8-%EC%84%9C%EB%B8%8C%EB%8F%84%EB%A9%94%EC%9D%B8-%EB%B0%94%EC%9A%B4%EB%94%94%EB%93%9C-%EC%BB)
- 아래는 나쁜 설계의 한 예.
...
![keep useful](/til/2017/keep-useful.png)

그리고 대답이 될 수 있는 그림과 이야기.

![stagnation, useful, volatile](/til/2017/stagnation-useful-volatile.png)
...
- [[도메인 주도 설계 핵심] 도메인 이벤트와 전술적 설계](/book/dddd/README.md)
